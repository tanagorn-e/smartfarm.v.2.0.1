! function(t, e) { "object" == typeof exports && "undefined" != typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define(e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).bootstrap = e() }(this, function() {
    ...
    function j(t) { var e = S(t); return t.uidEvent = e, A[e] = A[e] || {}, A[e] }
    ...
    var B = {
            on: function(t, e, n, i) { P(t, e, n, i, !1) },
            one: function(t, e, n, i) { P(t, e, n, i, !0) },
    ...
    B.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', W.handleDismiss(new W)), b(function() {
        ...
        if (t) {
            var e = t.fn[R];
            t.fn[R] = W.jQueryInterface, t.fn[R].Constructor = W, t.fn[R].noConflict = function() { return t.fn[R] = e, W.jQueryInterface }
        }
    });
    var K = function(t) {
        function n() { return t.apply(this, arguments) || this }
    ...
    B.on(document, "click.bs.button.data-api", '[data-bs-toggle="button"]', function(t) {
        ...
        if (t) {
            var e = t.fn.button;
            t.fn.button = K.jQueryInterface, t.fn.button.Constructor = K, t.fn.button.noConflict = function() { return t.fn.button = e, K.jQueryInterface }
        }
    });
    var F = {
            ...
            getDataAttribute: function(t, e) { return Q(t.getAttribute("data-bs-" + U(e))) },
        ...
        $ = function(t) {
            function o(e, n) { var i; return (i = t.call(this, e) || this)._items = null, i._interval = null, i._activeElement = null, i._isPaused = !1, i._isSliding = !1, i.touchTimeout = null, i.touchStartX = 0, i.touchDeltaX = 0, i._config = i._getConfig(n), i._indicatorsElement = Y.findOne(".carousel-indicators", i._element), i._touchSupported = "ontouchstart" in document.documentElement || navigator.maxTouchPoints > 0, i._pointerEvent = Boolean(window.PointerEvent), i._addEventListeners(), i }
            i(o, t);
            var r = o.prototype;
            return r.next = function() { this._isSliding || this._slide("next") }, r.nextWhenVisible = function() {!document.hidden && g(this._element) && this.next() }, r.prev = function() { this._isSliding || this._slide("prev") }, r.pause = function(t) { t || (this._isPaused = !0), Y.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (f(this._element), this.cycle(!0)), clearInterval(this._interval), this._interval = null }, r.cycle = function(t) { t || (this._isPaused = !1), this._interval && (clearInterval(this._interval), this._interval = null), this._config && this._config.interval && !this._isPaused && (this._updateInterval(), this._interval = setInterval((document.visibilityState ? this.nextWhenVisible : this.next).bind(this), this._config.interval)) }, r.to = function(t) {
                var e = this;
            ...
            }, r.dispose = function() { t.prototype.dispose.call(this), B.off(this._element, ".bs.carousel"), this._items = null, this._config = null, this._interval = null, this._isPaused = null, this._isSliding = null, this._activeElement = null, this._indicatorsElement = null }, r._getConfig = function(t) { return t = n({}, z, t), p(q, t, V), t }, r._handleSwipe = function() {
                ...
                var t = this,
                    ...
                    n = function(e) { t._pointerEvent && X[e.pointerType.toUpperCase()] && (t.touchDeltaX = e.clientX - t.touchStartX), t._handleSwipe(), "hover" === t._config.pause && (t.pause(), t.touchTimeout && clearTimeout(t.touchTimeout), t.touchTimeout = setTimeout(function(e) { return t.cycle(e) }, 500 + t._config.interval)) };
            ...
            }, r._getItemIndex = function(t) { return this._items = t && t.parentNode ? Y.find(".carousel-item", t.parentNode) : [], this._items.indexOf(t) }, r._getItemByDirection = function(t, e) {
                var n = "next" === t,
                    i = "prev" === t,
                ...
                if ("next" === t ? (n = "carousel-item-start", i = "carousel-item-next", o = "left") : (n = "carousel-item-end", i = "carousel-item-prev", o = "right"), l && l.classList.contains("active")) this._isSliding = !1;
                    ...
                    if (this._isSliding = !0, f && this.pause(), this._setActiveIndicatorElement(l), this._activeElement = l, this._element.classList.contains("slide")) {
                        ...
                        var d = u(s);
                        B.one(s, "transitionend", function() { l.classList.remove(n, i), l.classList.add("active"), s.classList.remove("active", i, n), r._isSliding = !1, setTimeout(function() { B.trigger(r._element, "slid.bs.carousel", { relatedTarget: l, direction: o, from: a, to: c }) }, 0) }), h(s, d)
            ...
            }, e(o, null, [{ key: "Default", get: function() { return z } }, { key: "DATA_KEY", get: function() { return "bs.carousel" } }]), o
        }(H);
    B.on(document, "click.bs.carousel.data-api", "[data-bs-slide], [data-bs-slide-to]", $.dataApiClickHandler), B.on(window, "load.bs.carousel.data-api", function() { for (var t = Y.find('[data-bs-ride="carousel"]'), e = 0, n = t.length; e < n; e++) $.carouselInterface(t[e], T(t[e], "bs.carousel")) }), b(function() {
        var t = _();
        if (t) {
            var e = t.fn[q];
            t.fn[q] = $.jQueryInterface, t.fn[q].Constructor = $, t.fn[q].noConflict = function() { return t.fn[q] = e, $.jQueryInterface }
        }
    });
    var G = "collapse",
        Z = { toggle: !0, parent: "" },
        ...
        tt = function(t) {
            function o(e, n) {
                ...
                for (var o = Y.find('[data-bs-toggle="collapse"]'), r = 0, s = o.length; r < s; r++) {
                    var a = o[r],
                        c = l(a),
                        u = Y.find(c).filter(function(t) { return t === e });
            ...
            }, r.setTransitioning = function(t) { this._isTransitioning = t }, r.dispose = function() { t.prototype.dispose.call(this), this._config = null, this._parent = null, this._triggerArray = null, this._isTransitioning = null }, r._getConfig = function(t) { return (t = n({}, Z, t)).toggle = Boolean(t.toggle), p(G, t, J), t }, r._getDimension = function() { return this._element.classList.contains("width") ? "width" : "height" }, r._getParent = function() {
                var t = this,
    ...
    var et = "top",
        ...
        ot = "left",
        rt = [et, nt, it, ot],
        st = rt.reduce(function(t, e) { return t.concat([e + "-start", e + "-end"]) }, []),
        at = [].concat(rt, ["auto"]).reduce(function(t, e) { return t.concat([e, e + "-start", e + "-end"]) }, []),
    ...
    function ut(t) { if ("[object Window]" !== t.toString()) { var e = t.ownerDocument; return e && e.defaultView || window } return t }

    function ft(t) { return t instanceof ut(t).Element || t instanceof Element }

    function dt(t) { return t instanceof ut(t).HTMLElement || t instanceof HTMLElement }
    var ht = {
        name: "applyStyles",
        enabled: !0,
        phase: "write",
        fn: function(t) {
            ...
            Object.keys(e.elements).forEach(function(t) {
                var n = e.styles[t] || {},
                    i = e.attributes[t] || {},
                    o = e.elements[t];
                dt(o) && ct(o) && (Object.assign(o.style, n), Object.keys(i).forEach(function(t) { var e = i[t];!1 === e ? o.removeAttribute(t) : o.setAttribute(t, !0 === e ? "" : e) }))
            })
        },
        effect: function(t) {
            var e = t.state,
            ...
            return Object.assign(e.elements.popper.style, n.popper), e.elements.arrow && Object.assign(e.elements.arrow.style, n.arrow),
                function() {
                    Object.keys(e.elements).forEach(function(t) {
                        ...
                        dt(i) && ct(i) && (Object.assign(i.style, r), Object.keys(o).forEach(function(t) { i.removeAttribute(t) }))
                    })
                }
        },
    ...
    function gt(t) { return { x: t.offsetLeft, y: t.offsetTop, width: t.offsetWidth, height: t.offsetHeight } }
    ...
    function vt(t) { return ut(t).getComputedStyle(t) }

    function _t(t) { return ["table", "td", "th"].indexOf(ct(t)) >= 0 }

    function bt(t) { return ((ft(t) ? t.ownerDocument : t.document) || window.document).documentElement }

    function yt(t) { return "html" === ct(t) ? t : t.assignedSlot || t.parentNode || t.host || bt(t) }

    function wt(t) { if (!dt(t) || "fixed" === vt(t).position) return null; var e = t.offsetParent; if (e) { var n = bt(e); if ("body" === ct(e) && "static" === vt(e).position && "static" !== vt(n).position) return n } return e }
    ...
    function kt(t, e, n) { return Math.max(t, Math.min(e, n)) }

    function Ot(t) { return Object.assign(Object.assign({}, { top: 0, right: 0, bottom: 0, left: 0 }), t) }

    function Lt(t, e) { return e.reduce(function(e, n) { return e[n] = t, e }, {}) }
    var At = {
            name: "arrow",
            enabled: !0,
            phase: "main",
    ...
    var xt = {
        ...
        jt = {
            ...
            effect: function(t) {
                ...
                return r && c.forEach(function(t) { t.addEventListener("scroll", n.update, St) }), a && l.addEventListener("resize", n.update, St),
                    function() { r && c.forEach(function(t) { t.removeEventListener("scroll", n.update, St) }), a && l.removeEventListener("resize", n.update, St) }
            },
            data: {}
        },
        Nt = { left: "right", right: "left", bottom: "top", top: "bottom" };

    function It(t) { return t.replace(/left|right|bottom|top/g, function(t) { return Nt[t] }) }
    var Pt = { start: "end", end: "start" };

    function Mt(t) { return t.replace(/start|end/g, function(t) { return Pt[t] }) }

    function Bt(t) { var e = t.getBoundingClientRect(); return { width: e.width, height: e.height, top: e.top, right: e.right, bottom: e.bottom, left: e.left, x: e.left, y: e.top } }

    function Ht(t) { var e = ut(t); return { scrollLeft: e.pageXOffset, scrollTop: e.pageYOffset } }

    function Rt(t) { return Bt(bt(t)).left + Ht(t).scrollLeft }
    ...
    function Kt(t, e) {
        void 0 === e && (e = []);
        var n = function t(e) { return ["html", "body", "#document"].indexOf(ct(e)) >= 0 ? e.ownerDocument.body : dt(e) && Wt(e) ? e : t(yt(e)) }(t),
            i = "body" === ct(n),
            o = ut(n),
    ...
    function Qt(t) { return Object.assign(Object.assign({}, t), {}, { left: t.x, top: t.y, right: t.x + t.width, bottom: t.y + t.height }) }
    ...
    function Ut(t, e) {
        ...
        }(t)) : dt(e) ? function(t) { var e = Bt(t); return e.top = e.top + t.clientTop, e.left = e.left + t.clientLeft, e.bottom = e.top + t.clientHeight, e.right = e.left + t.clientWidth, e.width = t.clientWidth, e.height = t.clientHeight, e.x = e.left, e.y = e.top, e }(e) : Qt(function(t) {
            var e = bt(t),
                n = Ht(t),
        ...
        var n = e,
            ...
            y = function(t, e, n) {
                var i = "clippingParents" === e ? function(t) {
                        ...
                        return ft(n) ? e.filter(function(t) { return ft(t) && mt(t, n) && "body" !== ct(t) }) : []
                    }(t) : [].concat(e),
                    o = [].concat(i, [n]),
                    r = o[0],
    ...
    var zt = {
        ...
        fn: function(t) {
            ...
            if (!e.modifiersData[i]._skip) {
                for (var o = n.mainAxis, r = void 0 === o || o, s = n.altAxis, a = void 0 === s || s, l = n.fallbackPlacements, c = n.padding, u = n.boundary, f = n.rootBoundary, d = n.altBoundary, h = n.flipVariations, p = void 0 === h || h, g = n.allowedAutoPlacements, m = e.options.placement, v = pt(m), _ = l || (v !== m && p ? function(t) { if ("auto" === pt(t)) return []; var e = It(t); return [Mt(t), e, Mt(e)] }(m) : [It(m)]), b = [m].concat(_).reduce(function(t, n) {
                        return t.concat("auto" === pt(n) ? function(t, e) {
                            ...
                            var n = e,
                                ...
                                c = void 0 === l ? at : l,
                                u = Ft(i),
                                f = u ? a ? st : st.filter(function(t) { return Ft(t) === u }) : rt,
                                d = f.filter(function(t) { return c.indexOf(t) >= 0 });
                            0 === d.length && (d = f);
                            var h = d.reduce(function(e, n) { return e[n] = qt(t, { placement: n, boundary: o, rootBoundary: r, padding: s })[pt(n)], e }, {});
                ...
                if (T)
                    for (var P = function(t) { var e = b.find(function(e) { var n = E.get(e); if (n) return n.slice(0, t).every(function(t) { return t }) }); if (e) return k = e, "break" }, M = p ? 3 : 1; M > 0 && "break" !== P(M); M--);
    ...
    function Xt(t) { return [et, it, nt, ot].some(function(e) { return t[e] >= 0 }) }
    var $t = {
            name: "hide",
            enabled: !0,
            phase: "main",
    ...
    function te(t, e, n) {
        ...
        var i, o, r = bt(e),
            ...
            c = { x: 0, y: 0 };
        return (a || !a && !n) && (("body" !== ct(e) || Wt(r)) && (l = (i = e) !== ut(i) && dt(i) ? { scrollLeft: (o = i).scrollLeft, scrollTop: o.scrollTop } : Ht(i)), dt(e) ? ((c = Bt(e)).x += e.clientLeft, c.y += e.clientTop) : r && (c.x = Rt(r))), { x: s.left + l.scrollLeft - c.x, y: s.top + l.scrollTop - c.y, width: s.width, height: s.height }
    }
                ...
                u = {
                    ...
                    setOptions: function(n) {
                        ...
                        var o, s, c = function(t) {
                            ...
                            return lt.reduce(function(t, n) { return t.concat(e.filter(function(t) { return t.phase === n })) }, [])
                    ...
                    forceUpdate: function() {
                        if (!c) {
                            var t = a.elements,
                                ...
                                n = t.popper;
                            if (ne(e, n)) {
                                a.rects = { reference: te(e, Et(n), "fixed" === a.options.strategy), popper: gt(n) }, a.reset = !1, a.placement = a.options.placement, a.orderedModifiers.forEach(function(t) { return a.modifiersData[t.name] = Object.assign({}, t.data) });
    ...
    var oe = ie(),
        ...
        _e = function(t) {
            ...
            return r.toggle = function() {
            ...
            }, r._getConfig = function(t) { return t = n({}, this.constructor.Default, F.getDataAttributes(this._element), t), p(le, t, this.constructor.DefaultType), t }, r._getMenuElement = function() { return Y.next(this._element, ".dropdown-menu")[0] }, r._getPlacement = function() { var t = this._element.parentNode; if (t.classList.contains("dropend")) return pe; if (t.classList.contains("dropstart")) return ge; var e = "end" === getComputedStyle(this._menu).getPropertyValue("--bs-position").trim(); return t.classList.contains("dropup") ? e ? fe : ue : e ? he : de }, r._detectNavbar = function() { return null !== this._element.closest(".navbar") }, r._getPopperConfig = function() { var t = { placement: this._getPlacement(), modifiers: [{ name: "preventOverflow", options: { altBoundary: this._config.flip, rootBoundary: this._config.boundary } }] }; return "static" === this._config.display && (t.modifiers = [{ name: "applyStyles", enabled: !1 }]), n({}, t, this._config.popperConfig) }, o.dropdownInterface = function(t, e) {
                ...
                if (!(/input|textarea/i.test(t.target.tagName) ? "Space" === t.key || "Escape" !== t.key && ("ArrowDown" !== t.key && "ArrowUp" !== t.key || t.target.closest(".dropdown-menu")) : !ce.test(t.key)) && (t.preventDefault(), t.stopPropagation(), !this.disabled && !this.classList.contains("disabled"))) {
                    ...
                    if (n && "Space" !== t.key) { var i = Y.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", e).filter(g); if (i.length) { var r = i.indexOf(t.target); "ArrowUp" === t.key && r > 0 && r--, "ArrowDown" === t.key && r < i.length - 1 && r++, i[r = -1 === r ? 0 : r].focus() } } else o.clearMenus()
                }
            }, e(o, null, [{ key: "Default", get: function() { return me } }, { key: "DefaultType", get: function() { return ve } }, { key: "DATA_KEY", get: function() { return "bs.dropdown" } }]), o
        }(H);
    B.on(document, "keydown.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', _e.dataApiKeydownHandler), B.on(document, "keydown.bs.dropdown.data-api", ".dropdown-menu", _e.dataApiKeydownHandler), B.on(document, "click.bs.dropdown.data-api", _e.clearMenus), B.on(document, "keyup.bs.dropdown.data-api", _e.clearMenus), B.on(document, "click.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', function(t) { t.preventDefault(), t.stopPropagation(), _e.dropdownInterface(this, "toggle") }), B.on(document, "click.bs.dropdown.data-api", ".dropdown form", function(t) { return t.stopPropagation() }), b(function() {
        var t = _();
        if (t) {
            var e = t.fn[le];
            t.fn[le] = _e.jQueryInterface, t.fn[le].Constructor = _e, t.fn[le].noConflict = function() { return t.fn[le] = e, _e.jQueryInterface }
        }
    });
    var be = { backdrop: !0, keyboard: !0, focus: !0 },
        ye = { backdrop: "(boolean|string)", keyboard: "boolean", focus: "boolean" },
        we = function(t) {
            function o(e, n) { var i; return (i = t.call(this, e) || this)._config = i._getConfig(n), i._dialog = Y.findOne(".modal-dialog", e), i._backdrop = null, i._isShown = !1, i._isBodyOverflowing = !1, i._ignoreBackdropClick = !1, i._isTransitioning = !1, i._scrollbarWidth = 0, i }
            i(o, t);
            var r = o.prototype;
            ...
            }, r.handleUpdate = function() { this._adjustDialog() }, r._getConfig = function(t) { return t = n({}, be, t), p("modal", t, ye), t }, r._showElement = function(t) {
                var e = this,
    ...
    B.on(document, "click.bs.modal.data-api", '[data-bs-toggle="modal"]', function(t) {
        ...
        if (t) {
            var e = t.fn.modal;
            t.fn.modal = we.jQueryInterface, t.fn.modal.Constructor = we, t.fn.modal.noConflict = function() { return t.fn.modal = e, we.jQueryInterface }
        }
    });
    ...
    var Le = "tooltip",
        ...
        Ne = function(t) {
            ...
            return r.enable = function() { this._isEnabled = !0 }, r.disable = function() { this._isEnabled = !1 }, r.toggleEnabled = function() { this._isEnabled = !this._isEnabled }, r.toggle = function(t) {
                ...
                return !1
            }, r._getConfig = function(t) { var e = F.getDataAttributes(this._element); return Object.keys(e).forEach(function(t) { Ce.has(t) && delete e[t] }), t && "object" == typeof t.container && t.container.jquery && (t.container = t.container[0]), "number" == typeof(t = n({}, this.constructor.Default, e, "object" == typeof t && t ? t : {})).delay && (t.delay = { show: t.delay, hide: t.delay }), "number" == typeof t.title && (t.title = t.title.toString()), "number" == typeof t.content && (t.content = t.content.toString()), p(Le, t, this.constructor.DefaultType), t.sanitize && (t.template = Oe(t.template, t.allowList, t.sanitizeFn)), t }, r._getDelegateConfig = function() {
                var t = {};
                if (this.config)
            ...
            }, e(o, null, [{ key: "Default", get: function() { return Se } }, { key: "NAME", get: function() { return Le } }, { key: "DATA_KEY", get: function() { return "bs.tooltip" } }, { key: "Event", get: function() { return je } }, { key: "EVENT_KEY", get: function() { return ".bs.tooltip" } }, { key: "DefaultType", get: function() { return De } }]), o
        }(H);
    b(function() {
        var t = _();
        if (t) {
            var e = t.fn[Le];
            t.fn[Le] = Ne.jQueryInterface, t.fn[Le].Constructor = Ne, t.fn[Le].noConflict = function() { return t.fn[Le] = e, Ne.jQueryInterface }
        }
    });
    var Ie = "popover",
        ...
        Re = function(t) {
            ...
            }, e(n, null, [{ key: "Default", get: function() { return Me } }, { key: "NAME", get: function() { return Ie } }, { key: "DATA_KEY", get: function() { return "bs.popover" } }, { key: "Event", get: function() { return He } }, { key: "EVENT_KEY", get: function() { return ".bs.popover" } }, { key: "DefaultType", get: function() { return Be } }]), n
        }(Ne);
    b(function() {
        var t = _();
        if (t) {
            var e = t.fn[Ie];
            t.fn[Ie] = Re.jQueryInterface, t.fn[Ie].Constructor = Re, t.fn[Ie].noConflict = function() { return t.fn[Ie] = e, Re.jQueryInterface }
        }
    });
    var We = "scrollspy",
        ...
        Ue = function(t) {
            function o(e, n) { var i; return (i = t.call(this, e) || this)._scrollElement = "BODY" === e.tagName ? window : e, i._config = i._getConfig(n), i._selector = i._config.target + " .nav-link, " + i._config.target + " .list-group-item, " + i._config.target + " .dropdown-item", i._offsets = [], i._targets = [], i._activeTarget = null, i._scrollHeight = 0, B.on(i._scrollElement, "scroll.bs.scrollspy", function(t) { return i._process(t) }), i.refresh(), i._process(), i }
            i(o, t);
            var r = o.prototype;
            return r.refresh = function() {
                ...
                this._offsets = [], this._targets = [], this._scrollHeight = this._getScrollHeight(), Y.find(this._selector).map(function(t) {
                    ...
                    if (o) { var r = o.getBoundingClientRect(); if (r.width || r.height) return [F[n](o).top + i, e] }
                    return null
                ...
                var e = this._selector.split(",").map(function(e) { return e + '[data-bs-target="' + t + '"],' + e + '[href="' + t + '"]' }),
                    n = Y.findOne(e.join(","));
                n.classList.contains("dropdown-item") ? (Y.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add("active"), n.classList.add("active")) : (n.classList.add("active"), Y.parents(n, ".nav, .list-group").forEach(function(t) { Y.prev(t, ".nav-link, .list-group-item").forEach(function(t) { return t.classList.add("active") }), Y.prev(t, ".nav-item").forEach(function(t) { Y.children(t, ".nav-link").forEach(function(t) { return t.classList.add("active") }) }) })), B.trigger(this._scrollElement, "activate.bs.scrollspy", { relatedTarget: t })
            }, r._clear = function() { Y.find(this._selector).filter(function(t) { return t.classList.contains("active") }).forEach(function(t) { return t.classList.remove("active") }) }, o.jQueryInterface = function(t) {
                return this.each(function() {
            ...
            }, e(o, null, [{ key: "Default", get: function() { return Ke } }, { key: "DATA_KEY", get: function() { return "bs.scrollspy" } }]), o
        }(H);
    B.on(window, "load.bs.scrollspy.data-api", function() { Y.find('[data-bs-spy="scroll"]').forEach(function(t) { return new Ue(t, F.getDataAttributes(t)) }) }), b(function() {
        var t = _();
        if (t) {
            var e = t.fn[We];
            t.fn[We] = Ue.jQueryInterface, t.fn[We].Constructor = Ue, t.fn[We].noConflict = function() { return t.fn[We] = e, Ue.jQueryInterface }
        }
    });
    var Fe = function(t) {
        function n() { return t.apply(this, arguments) || this }
        ...
        return o.show = function() {
            ...
            t.classList.add("active"), "tab" === t.getAttribute("role") && t.setAttribute("aria-selected", !0), v(t), t.classList.contains("fade") && t.classList.add("show"), t.parentNode && t.parentNode.classList.contains("dropdown-menu") && (t.closest(".dropdown") && Y.find(".dropdown-toggle").forEach(function(t) { return t.classList.add("active") }), t.setAttribute("aria-expanded", !0)), n && n()
        }, n.jQueryInterface = function(t) {
            return this.each(function() {
    ...
    B.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', function(t) { t.preventDefault(), (T(this, "bs.tab") || new Fe(this)).show() }), b(function() {
        var t = _();
        if (t) {
            var e = t.fn.tab;
    ...
    var Ye = { animation: "boolean", autohide: "boolean", delay: "number" },
        ...
        ze = function(t) {
            ...
            }, r.dispose = function() { this._clearTimeout(), this._element.classList.contains("show") && this._element.classList.remove("show"), B.off(this._element, "click.dismiss.bs.toast"), t.prototype.dispose.call(this), this._config = null }, r._getConfig = function(t) { return t = n({}, qe, F.getDataAttributes(this._element), "object" == typeof t && t ? t : {}), p("toast", t, this.constructor.DefaultType), t }, r._setListeners = function() {
                var t = this;
            ...
            }, e(o, null, [{ key: "DefaultType", get: function() { return Ye } }, { key: "Default", get: function() { return qe } }, { key: "DATA_KEY", get: function() { return "bs.toast" } }]), o
        }(H);
    return b(function() {
        var t = _();
        if (t) {
